...
- CBL `WVt6gvghL2nFVbt6` (versionId **`9f69b166`** — R2-3a dirs, 73 nodos; cadena 17-07: `7cf87074`→`1cebb413`→`051731bd`→`9f69b166`) · Mailing `kh6TORgRg9R1Shj1` (versionId **`943bbc15`** — party_dirs/pais_destino; TEST_MODE ON) · Gmail→Drive `pBN4Wd1lcTSHNkFg` (versionId **`b8d997d6`** — captura + extracción factura R2·C)
