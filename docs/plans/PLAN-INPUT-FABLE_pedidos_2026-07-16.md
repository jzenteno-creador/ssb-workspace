...
| R2·A | **🛑 GO GATE** — rediseño lógica CO: la factura (origen argentino) DISPARA, el admin gestiona EXCEPCIONES por dimensión (región/país/destino/cliente) | Propuesta en `docs/plans/PROPUESTA_R2_CO_por_origen_2026-07-17.md` — **espera GO de John** (3 preguntas abiertas: TdF por material · override por orden se mantiene? · "destino"=puerto?) |
| R2·B | **🛑 GO GATE** — mockup Seguimiento v2: DOS ítems del rail (Marítimo/Terrestre), full-width, triangulación v2, desplegable por fila (producto factura + contenedores BL / CRT terrestre), botón "Despacho de planta" | Mockup servido: `http://localhost:8899/docs/mockups/mockup_r2_seguimiento_v2.html` — **espera GO visual** (2 preguntas en el mockup: CRT terrestre alcanza? · columnas CO/Progreso vuelven?) |
...
| R2·F | Implementar Seguimiento v2 (post-GO de R2·B) | ⏸ bloqueado por GO |
| R2·G | Implementar rediseño CO (post-GO de R2·A; usa el origen de R2·C) | ⏸ bloqueado por GO |
